...
; Dosya ismi       : pwm.asm
; Donanim          : AduC842
; Aciklama         : P2.7 pin cikisindan 1 KHz ve %50 doluluk oraniyla pwm uretilmesi
...
CSEG
	    ...
	    MOV    PWM1H,#41H             ; PWM SINYAL FREKANSININ 1 KHz AYARLANMASI
		MOV    PWM1L,#89H             	
		
	    MOV    PWM0H,#20H             ; PWM SINYALININ DOLULUK ORANIN %50 AYARLANMASI
		MOV    PWM0L,#0C4H             
