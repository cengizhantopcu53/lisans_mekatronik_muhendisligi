<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UrunGuncelleme.aspx.cs" Inherits="Odev6_TicariAlisverisSitesi.GuncellemeSayfasi" %>
    ...
    <div class="main">
        <div class="main-w3l">
            ...
            <div class="w3layouts-main">
                <h2><span>Ürün Güncelleme Sayfası</span></h2>
                <form action="#" method="post" runat="server">
                    ...
                    <asp:Button ID="BtnGuncelle" runat="server" Text="Güncelle" OnClick="BtnGuncelle_Click" CssClass="auto-style2" Font-Size="Large"/>
                    </strong>
                    <br />
                    <br />
                    <strong>
